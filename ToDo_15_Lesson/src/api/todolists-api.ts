...
import {LogingDataType} from "../features/Login/Login";
...
type UserDataType = {id:number,email:string,login:string}


//auth
export const authAPI = {
    login(data:LogingDataType){
       return instance.post<ResponseType<{userId:number}>,AxiosResponse<ResponseType<{userId:number}>>,LogingDataType>('auth/login',data)
    },
    me() {
